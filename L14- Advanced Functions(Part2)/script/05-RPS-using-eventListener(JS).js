// setInterval actually returns a number , this no is like a id , wecan use it to stop the interval
...
function autoplay(){
    ...
    isAutoPlayingON = true;
    }
    else{
        clearInterval(intervalId);   // STOPS THE INTERVAL
        isAutoPlayingON = false;
    }

}

document.querySelector('.js-rock-button').addEventListener('click', () => {   // ask cgpt why function inside function ?
    playGame('rock');
});
